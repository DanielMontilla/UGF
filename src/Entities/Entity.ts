...
export default abstract class Entity {
   ...
   public constructor(
      ...
      private _xAnchor: number = 0.5,
      private _yAnchor: number = 0.5,
   ...
   get position(): [x: number, y: number, z: number] {
      return [this._x, this._y, this.layer];
   }
   get origin(): [xOrigin: number, yOrigin: number] {
      return [this._xOrigin, this._yOrigin];
   }
   get offset(): [xOffset: number, yOffset: number] {
