...
import { RectangleComponent, SpriteComponent } from "../../../components";
...
import vertexShaderSource from "../../../data/shaders/sprite/vertex.glsl?raw";
import fragmentShaderSource from "../../../data/shaders/sprite/fragment.glsl?raw";
...
export class SpritePipeline extends Pipeline<SpriteComponent> {
  
  public readonly primitive: ComponentPrimitive = 'sprite';

  public get textureManager(): TextureManager { return this.rendererRef.textureManager }
  
  public readonly MAX_SPRITES: number = 2**10;
  public readonly INDICES_PER_SPRITE: number = INDICES_PER_QUAD;
  public readonly VERTICES_PER_SPRITE: number = VERTEX_PER_QUAD;
  ...
  public constructor(rendererRef: WebGL2Renderer) {
    ...
    const { context, program, projectionMatrix, viewMatrix, vertexDataBuffer, instanceDataBuffer, indexBuffer, MAX_SPRITES } = this;
  ...
  public draw(rectangles: SpriteComponent[]): void {
